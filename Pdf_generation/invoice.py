    ...
    def edit_pdf(self, search_texts, text_positions=None):
        ...
        if text_positions is None:
            text_positions = {
                ...
                "Date": {"x": 45, "y": 0+2, "font_size": 10, "font_name": "Helvetica"},
                "Invoice": {"x": 30, "y": 3, "font_size": 10, "font_name": "Helvetica"},
                "UPI": {"x": 95, "y": 4, "font_size": 12, "font_name": "Helvetica"},
                "DESCRIPTION": {"x": -80, "y": -45+2, "font_size": 12, "font_name": "Helvetica"},
                "SUBTOTAL": {"x": -40, "y": -45+2, "font_size": 12, "font_name": "Helvetica"},
                "Amount": {"x": 40, "y": 5-1, "font_size": 16, "font_name": "Helvetica"},
            }
...
class Invoice_generation_config:
    def __init__(self):
        pass
